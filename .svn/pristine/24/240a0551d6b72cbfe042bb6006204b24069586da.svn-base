							...
							<div class="mb-xl-0 mb-4">
								<div class="card card-blog card-plain">
									...
									<div class="d-flex align-items-center">
										<table class="w-100">
											<tbody><tr>
												<td class="w-50 align-items-center"><a href="#" class="btn btn-lg p-4" data-bypass="true" style="margin-left:50px;"> <span class="ic_dashboard2 ic_create_survey" title="메일쓰기"><img class="img" alt="" src="/resources/soft-dashboard/assets/img/mail.png" style="width: 25px;"></span> <span class="txt" style="width:30px;">이메일</span>
												</a></td>
