	...
	<div class="container-fluid py-1 px-3">
		...
		<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4"
			...
			<ul class="navbar-nav  justify-content-end">
				<li class="nav-item px-2 d-flex align-items-center">
					...
					<img class="img" alt=""
						src="/resources/soft-dashboard/assets/img/paper.png"
						style="width: 30px;">
					</a>
				</li>
			<!-- 체크리스트 시작 -->
				<li class="nav-item dropdown px-2 d-flex align-items-center">
					<a href="#" class="nav-link text-body p-0" id="dropdownMenuButton"
						...
						src="/resources/soft-dashboard/assets/img/check-list.png">
					</a>
		...
		<!-- 알림 시작 -->
				...
				<a href="#" class="nav-link text-body p-0" id="dropdownMenuButton"
					...
					src="/resources/soft-dashboard/assets/img/bell2.png" style="width: 30px;">
						<span id="alarmCount"
