...
<%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags"%>
	...
	<script src="/resources/soft-dashboard/assets/js/plugins/flatpickr.min.js"></script>	
							...
							<div class="row mt-4">
								<div class="col-12">
									<div class="card bg-gradient-secondary">
										<img src="/resources/soft-dashboard/assets/img/shapes/waves-white.svg"
		...
		<div class="row" style="margin: auto;" >
            ...
            <button type="button" class="btn bg-info btn-lg text-lg" id="reserveStart" style="color:white;">예약 신청</button>
             ...
             <div class="col-6" align="left">
             	<br>
             	<br>
            <a class="btn bg-secondary btn-lg text-lg" style="color:white;" href="/admin/car">차량 목록</a>
             </div>
           </div>
		  </div>
