						                ...
						                <div class="d-flex mt-3 cmntInfo">
						                  ...
						                  <c:choose>
												...
												<c:when test="${authority eq 'admin'}">
													<img src="/resources/soft-dashboard/assets/img/user1.png" class="avatar rounded-circle me-3 img" alt="관리자user1.png" style="width: 50px; border-radius: 50px; object-fit:cover;">
												</c:when>
												<c:otherwise>
