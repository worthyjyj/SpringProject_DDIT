...
<link rel="apple-touch-icon" sizes="76x76"
	href="/resources/soft-dashboard/assets/img/apple-icon.png">
<link rel="icon" type="image/png"
	href="/resources/soft-dashboard/assets/img/bear2.png">
...
<link href="/resources/soft-dashboard/assets/css/nucleo-icons.css"
	rel="stylesheet" />
<link href="/resources/soft-dashboard/assets/css/nucleo-svg.css"
	rel="stylesheet" />
...
<link id="pagestyle"
	href="/resources/soft-dashboard/assets/css/soft-ui-dashboard.min.css?v=1.1.1"
	rel="stylesheet" />
...
<body class="g-sidenav-show  bg-gray-100">
	...
	<script
		src="/resources/soft-dashboard/assets/js/plugins/perfect-scrollbar.min.js"></script>
	<script
		src="/resources/soft-dashboard/assets/js/plugins/smooth-scrollbar.min.js"></script>
	<script
		src="/resources/soft-dashboard/assets/js/plugins/fullcalendar.min.js"></script>

	<script
		src="/resources/soft-dashboard/assets/js/plugins/dragula/dragula.min.js"></script>
	<script
		src="/resources/soft-dashboard/assets/js/plugins/jkanban/jkanban.js"></script>
	<script
		src="/resources/soft-dashboard/assets/js/plugins/chartjs.min.js"></script>
	<script>
