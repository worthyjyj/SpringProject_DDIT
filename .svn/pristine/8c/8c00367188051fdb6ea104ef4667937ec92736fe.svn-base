			   ...
			   <div class="panel panel-default">
		            ...
		            <div class="panel-body" style="margin-left:10px;">
		                ...
		                <div class="row" style="padding:5px;">
		                    <div class="input-group">
		                    <h4>등록자 : <input class='filter' type="checkbox" value="${empNm}" checked hidden>${empNm}</h4>
		                    <input class='filter' type="checkbox" value="그루IT" checked hidden>
		                    </div>
		                </div>
		            </div>
		            <a class="btn btn-primary btn-default" href="/cal/calendar" style="width: 140px; padding:5px; margin-bottom: 20px; margin-left: 18px;"><h5>내 캘린더로 가기</h5></a>
		        </div>
		        <!-- aside 끝 -->
			</div>
...
<!-- authorize 부분 끝. 중요! -->	
    ...
    <script src="/resources/FullCalendar/WebContent/js/main2.js"></script>
