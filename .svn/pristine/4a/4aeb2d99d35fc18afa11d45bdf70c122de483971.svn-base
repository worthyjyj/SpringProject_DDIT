...
<!-- 		</a> -->
	...
	<div class="collapse navbar-collapse  w-auto h-auto ps" id="sidenav-collapse-main">
		...
		<a href="/main" class="nav-link nl" role="button" aria-expanded="false">
			<div class="d" >
				<img class="img" alt="" src="/resources/soft-dashboard/assets/img/home1.png" style="width: 25px;">
			</div>
		...
		<a href="/address/list" class="nav-link nl" role="button" aria-expanded="false">
			<div class="d" >
				<img class="img" alt="" src="/resources/soft-dashboard/assets/img/phn.png" style="width: 25px;">
			</div>
		...
		<a href="/mail/recieveList" class="nav-link nl" role="button" aria-expanded="false">
			<div class="d" >
				<img class="img" alt="" src="/resources/soft-dashboard/assets/img/mail.png" style="width: 25px;">
			</div>
		...
		<a href="/work/workList" class="nav-link nl" role="button" aria-expanded="false">
			<div class="d" >
				<img class="img" alt="" src="/resources/soft-dashboard/assets/img/bag.png" style="width: 25px;">
			</div>
		...
		<a href="/dailyReport/main" class="nav-link nl" role="button" aria-expanded="false">
			<div class="d" >
				<img class="img" alt="" src="/resources/soft-dashboard/assets/img/business-report.png" style="width: 25px;">
			</div>
		...
		<a href="/projects/projList" class="nav-link nl" role="button" aria-expanded="false">
			<div class="d" >
				<img class="img" alt="" src="/resources/soft-dashboard/assets/img/works.png" style="width: 25px;">
			</div>
		...
		<a href="/survey/main" class="nav-link nl" role="button" aria-expanded="false">
			<div class="d" >
				<img class="img" alt="" src="/resources/soft-dashboard/assets/img/survey.png" style="width: 25px;">
			</div>
		...
		<a href="/archive/bookmark" class="nav-link nl" role="button" aria-expanded="false">
			<div class="d" >
				<img class="img" alt="" src="/resources/soft-dashboard/assets/img/cloud.png" style="width: 25px;">
			</div>
		...
		<a href="/reserve/myres" class="nav-link nl" role="button" aria-expanded="false">
			<div class="d" >
				<img class="img" alt="" src="/resources/soft-dashboard/assets/img/res.png" style="width: 25px;">
			</div>
