	...
	<div class="row mb-5">
		...
		<div class="col-lg-9 mt-lg-0 mt-4 mb-4">
			<div class="my-0 py-0 mx-0">
				<h2 class="" style="font-color: black;">결재할 문서</h2>
			</div>
			...
			<div class="card">
				...
				<c:out value="selected"/></c:if>>
						...
						<input type="submit" class="btn btn-outline-dark  m-0 pb-2 align-middle text-center" style="height:37px;"
							value="검색">
					</form>
				</div>
									...
									<c:forEach var="edoc" items="${dataList}" >
										<tr class="getAtrz">
											...
											<td class="align-middle text-center " style="font-size:1.2em;">
												<a href="" onclick="window.open('/edoc/edocDetail?edocVO.edocNo=${edoc.EDOC_NO}&edocVO.edocFormClsf=${edoc.EDOC_FORM_CLSF}&approve=1','_blank','toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=800, height=1100')">
												${edoc.EDOC_TTL}</a></td>
											<td class="align-middle text-center" style="font-size:1.2em;">${edoc.EMP_INIT_NO}</td>
											<td class="align-middle text-center" style="font-size:1.2em;">${edoc.EMP_INIT_NM}</td>
											<td class="align-middle text-center" style="font-size:1.2em;">${edoc.ATRZ_RECEIPT_DT}</td>
			...
			<div class="card">
				<div class="table-responsive">
					<table class='table align-items-center mb-0' id='myTable'>
						...
						<th class='text-center text-dark text-md font-weight-bolder' style="font-size:1.2em;">처리일시</th>
						</tr></thead>
						<tbody id="getAT">
									<tr>
