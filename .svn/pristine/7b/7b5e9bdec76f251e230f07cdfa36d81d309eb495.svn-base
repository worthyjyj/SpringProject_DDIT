...
<link rel="apple-touch-icon" sizes="76x76" href="/resources/soft-dashboard/assets/img/apple-icon.png">
<link rel="icon" type="image/png" href="/resources/soft-dashboard/assets/img/bear2.png">
...
<link href="/resources/soft-dashboard/assets/css/nucleo-icons.css" rel="stylesheet" />
<link href="/resources/soft-dashboard/assets/css/nucleo-svg.css" rel="stylesheet" />
<script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
<link href="/resources/soft-dashboard/assets/css/nucleo-svg.css" rel="stylesheet" />
<link id="pagestyle" href="/resources/soft-dashboard/assets/css/soft-ui-dashboard.min.css?v=1.1.1" rel="stylesheet" />
...
<div class='modal fade' id='exampleModalMessage' tabindex='-1' role='dialog' aria-labelledby='exampleModalMessageTitle' aria-hidden='true'>
  <div class='modal-dialog modal-dialog-centered modal-lg' role='document'>
	...
	<!--   Core JS Files   -->
	<script src="/resources/soft-dashboard/assets/js/core/popper.min.js"></script>
	<script src="/resources/soft-dashboard/assets/js/core/bootstrap.min.js"></script>
	<script src="/resources/soft-dashboard/assets/js/plugins/perfect-scrollbar.min.js"></script>
	<script src="/resources/soft-dashboard/assets/js/plugins/smooth-scrollbar.min.js"></script>
	<script src="/resources/soft-dashboard/assets/js/plugins/fullcalendar.min.js"></script>
	<script src="/resources/soft-dashboard/assets/js/plugins/dragula/dragula.min.js"></script>
	<script src="/resources/soft-dashboard/assets/js/plugins/jkanban/jkanban.js"></script>
	<script src="/resources/soft-dashboard/assets/js/plugins/chartjs.min.js"></script>
	...
	<script
		src="/resources/soft-dashboard/assets/js/soft-ui-dashboard.min.js?v=1.1.1"></script>
	<script defer
		...
		$.ajax({
			...
			success:function(result){
				...
				$('#modal_goEmail').html("<a href='/mail/clickWrite?empNo="+result.empNo+"' class='btn btn-lg p-4' data-bypass='true' style='margin-left:30px; width:130px;'>"
                   ...
                   +"<img class='img' alt='' src='/resources/soft-dashboard/assets/img/mail.png' style='width: 25px; margin-right:10px;'></span>"
			...
			+"</a>");
				...
				+"<img class='img' alt='' src='/resources/soft-dashboard/assets/img/cal.png' style='width: 25px; margin-right:10px;'>"
