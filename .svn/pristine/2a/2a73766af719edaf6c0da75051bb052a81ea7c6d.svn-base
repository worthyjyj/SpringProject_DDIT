				...
				<div class="row">
												...
												<tr>
													<td>
														<a href="/mail/write" class="btn btn-outline-dark btn-lg p-4 m-2" data-bypass="true" style="border: 2px solid;">
															<span class="ic_dashboard2 ic_create_survey" title="메일쓰기">
																<img class="img" alt="" src="/resources/soft-dashboard/assets/img/mail.png" style="width: 25px;"></span>
													...
													<td>
														...
														<span class="type">
															...
															<img class="img" alt="" src="/resources/soft-dashboard/assets/img/cal.png" style="width: 25px;">
															</span>
														</span>
														...
														<a href="/survey/create" class="btn btn-outline-dark btn-lg p-4 m-2" data-bypass="true" style="border: 2px solid;">
															<span class="type">
																<span class="ic_dashboard2 ic_create_survey" title="설문작성">
																	<img class="img" alt="" src="/resources/soft-dashboard/assets/img/board.png" style="width: 25px;">
																</span>
															</span>
														...
														<a href="/edoc/main" class="btn btn-outline-dark btn-lg p-4 m-2" data-bypass="true" style="border: 2px solid;">
															<span class="type">
																<span class="ic_dashboard2 ic_create_survey" title="전자결재">
																	<img class="img" alt="" src="/resources/soft-dashboard/assets/img/sign.png" style="width: 25px;">
																</span>
															</span>
					...
					<div class="col-6">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<h4><img class="img mx-2 mb-1" alt="" src="/resources/soft-dashboard/assets/img/bag.png" style="width: 25px; magin-right:5px;">근태관리</h4>
								</div>

								<!-- 근태 통계 시작 -->
								<div class="row mt-4">
						<div class="col-lg-6 col-md-6 col-12">
							<div class="card" style="background-image: url('/resources/soft-dashboard/assets/img/curved-images/white-curved.jpeg')">
				...
				<hr/>
					...
					<div class="col">
						<div class="card">
							<div class="card-body">
								<div class="row">
									<h4><img class="img mx-2 mb-1" alt="" src="/resources/soft-dashboard/assets/img/business-report.png" style="width: 25px; magin-right:5px;">일일업무보고</h4>
								</div>
				...
				<div class="row">
					...
					<div class="col">
						<div class="card">
							<div class="card widget-calendar h-100">
								...
								<div class="row mt-2">
									<h4><img class="img mx-2 mb-1" alt="" src="/resources/soft-dashboard/assets/img/works.png" style="width: 25px; magin-right:5px;">참여중인 프로젝트</h4>
								</div>
						...
						<div class="card">
							<div class="card-header p-3 pb-0">
								<div class="row mx-0 mt-2">
									<div class="col-4">
										<div class="row">
											<h4><img class="img mx-2 mb-1" alt="" src="/resources/soft-dashboard/assets/img/sign.png" style="width: 25px; magin-right:5px;">결재대기문서</h4>
										</div>
					...
					<div class="col">
						<div class="card">
							<div class="card-header p-3 pb-0">
								<div class="row mt-2">
									<h4><img class="img mx-2 mb-1" alt="" src="/resources/soft-dashboard/assets/img/res.png" style="width: 25px; magin-right:5px;">예약 현황</h4>
								</div>
