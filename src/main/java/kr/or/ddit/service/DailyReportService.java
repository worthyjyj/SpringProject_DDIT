...
public interface DailyReportService {
	 ...
	 * @return
	 */
	public List<DailyReportVO> getAllList(Map<String, String> map);

	/**
	 * 사원번호를 입력받아 해당 사원의 부서별 일일업무보고의 목록을 불러오는 메서드
	 * 해당 사원이 속한 부서 외 상위 부서 정보도 포함
	 * @param map
	 * @return
	 */
	public List<DailyReportVO> getDeptList(Map<String, String> map);
	 ...
	 * @return
	 */
	public DailyReportVO getReportDetail(DailyReportVO dailyRVO);
	...
	/**
	 * 페이징
	 * 사원번호, 날짜 정보를 입력받아 사원의 업무보고 전체 행의 수를 가져오는 메서드
	 * @param map
	 * @return
	 */
