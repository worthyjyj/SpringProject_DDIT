...
public interface SrvyMapper {
	...
	/**
	 * 현재 설문조사 번호를 반환하는 메서드
	 * @return
	 */
	public String getCurrentSrvyNo();
	/**
	 * 현재 설문조사 질문번호를 반환하는 메서드
	 * @return
	 */
	public String getCurrentSrvyQstnNo();
	...
	/**
	 * 해시태그 그룹 번호를 추가하는 메서드
	 * @param srvyNo 해시태그를 추가한 설문조사 번호
	 * @return
	 */
	public int createHashTagGr(String srvyNo);
