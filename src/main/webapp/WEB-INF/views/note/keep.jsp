...
<!-- 상단에 들어가는 마이페이지 회원정보 끝 -->
		...
		<div class="container-fluid py-4">
			<div class="row">
				...
				<div class="dataTable-top" style="font-size:1.2em;">
													...
													<tbody>
														...
														<tr>
															<td  class="text-center">
																...
																<td  class="text-center">
																	<p class="text text-center text-secondary mb-0" style="font-size:1.2em;"><c:if test="${noteVO.msgCateTag eq '일반'}"><span class="badge badge-secondary">일반</span></c:if>
																		<c:if test="${noteVO.msgCateTag eq '긴급'}"><span class="badge badge-danger">긴급</span></c:if>
																	</p>
																</td>
																<td  class="text-center"><span class="badge badge-dot me-4" style="font-size:1.2em;"> <i class=""></i> <span class="text-center text-dark text">
																		<a style="color:#344767!important;" href="/note/rcvNtDetail?msgNo=${noteVO.msgNo}">${noteVO.msgCn}</a>																		</span>
																</span></td>
																<td  class="text-center"><span class="badge badge-dot me-4" style="font-size:1.2em;"> <i
																		class=""></i> <span class="text-center text-dark text">${noteVO.sender}</span>
																</span></td>
																<td  class="text-center"><span class="badge badge-dot me-4" style="font-size:1.2em;"> <i
