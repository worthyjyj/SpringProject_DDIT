							...
							<div class="row">
								<div class="col-lg-5 col-5">
									<div class="border-dashed border-1 border-secondary border-radius-md py-3 px-3 m-1">
										...
										<div id="orgList" style="overflow: scroll; height: 300px;">
											...
											<div class="row">
												<div class="col-12">
													<div class="table-responsive">
														<div class="border-dashed border-1 border-secondary border-radius-md py-3 px-3 m-1" style="height: 360px;">
															<div>
																<h5>쪽지 대상 추가</h5>
...
<!-- 		<div id="orgList"> -->
<!-- 			<ul id="browser" class="filetree treeview-famfamfam" > -->
<!-- 				<li class="dropdownLi" style="margin-left:-20px;"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder">그루IT</span> -->
<!-- 					<ul id="folder21" class="adminEmpNote"> -->
<!-- 					</ul> -->
<!-- 					<ul> -->
<!-- 						<li class="closed dropdownLi"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder" >경영지원본부</span> -->
<!-- 							<ul> -->
<!-- 								<li class="closed empListNote dropdownLi"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder" data-deptno="DEPT003">재무팀</span> -->
<!-- 									<ul id="folder21"> -->
<!-- 									</ul> -->
<!-- 								</li> -->
<!-- 								<li class="closed empListNote dropdownLi"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder" data-deptno="DEPT004">인사팀</span> -->
<!-- 									<ul id="folder21"> -->
<!-- 									</ul> -->
<!-- 								</li> -->
<!-- 								<li class="closed empListNote dropdownLi"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder" data-deptno="DEPT005">총무팀</span> -->
<!-- 									<ul id="folder21"> -->
<!-- 									</ul> -->
<!-- 								</li> -->
<!-- 							</ul> -->
<!-- 						</li> -->
<!-- 						<li class="closed dropdownLi"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder">영업본부</span> -->
<!-- 							<ul> -->
<!-- 								<li class="closed empListNote dropdownLi"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder" data-deptno="DEPT011">영업팀</span> -->
<!-- 									<ul id="folder21"></ul> -->
<!-- 								</li> -->
<!-- 								<li class="closed empListNote dropdownLi"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder" data-deptno="DEPT012">마케팅팀</span> -->
<!-- 									<ul id="folder21"> -->
<!-- 									</ul> -->
<!-- 								</li> -->
<!-- 								<li class="closed empListNote dropdownLi"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder" data-deptno="DEPT013">CS팀</span> -->
<!-- 									<ul id="folder21"> -->
<!-- 									</ul> -->
<!-- 								</li> -->
<!-- 							</ul> -->
<!-- 						</li> -->
<!-- 						<li class="closed"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder">개발본부</span> -->
<!-- 							<ul> -->
<!-- 								<li class="closed empListNote"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder" data-deptno="DEPT007">서비스개발팀</span> -->
<!-- 									<ul id="folder21"> -->
<!-- 									</ul> -->
<!-- 								</li> -->
<!-- 								<li class="closed empListNote"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder" data-deptno="DEPT008">플랫폼운영팀</span> -->
<!-- 									<ul id="folder21"> -->
<!-- 									</ul> -->
<!-- 								</li> -->
<!-- 								<li class="closed empListNote"><img <i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span class="folder" data-deptno="DEPT009">디자인팀</span> -->
<!-- 									<ul id="folder21"> -->
<!-- 									</ul> -->
<!-- 								</li> -->
<!-- 							</ul> -->
			...
			<div class="row">
					...
					<div class="card card-body mt-4 px-5">
						...
						<div class="row">
							...
							<div class="col-8">
								<!-- 이거!! -->
								<div style="border:2px solid #f5f7ff; width:auto; height:50px;" id="surveyTargetList"></div>
<!-- 								<input -->
...
<!-- 									id="noteList[0].empNoRcvr" name="noteList[0].empNoRcvr" /> -->
							...
							<div class="col-2">
							<input type="button" class="btn btn-lg btn-outline-secondary mx-auto my-auto px-2 " value="조직도"
										id="noteList[0].empNoRcvr" name="noteList[0].empNoRcvr"
