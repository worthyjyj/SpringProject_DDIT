...
<%@ taglib prefix="sec" uri="http://www.springframework.org/security/tags"%>
    ...
    <input  id="userno" name="userno" type="hidden" value="${empNoCo}">
    <input  id="username"  name="username" type="hidden" value="${empNmCo}">
	...
	<!-- 일자 클릭시 메뉴오픈 -->
        <div id="contextMenu" class="dropdown clearfix">
            <ul class="dropdown-menu dropNewEvent" role="menu" aria-labelledby="dropdownMenu"
                ...
                <li><a tabindex="-1" href="#">공통일정</a></li>
                <li class="divider"></li>
			   ...
			   <div class="panel panel-default">
		            ...
		            <div class="panel-body" style="margin-left:10px;">
		                ...
		                <div class="row" style="padding:5px;">
		                    <div class="input-group">
		                    <h4>일정 등록자 : <input class='filter' type="checkbox" value="${empNmCo}" checked hidden>${empNmCo}</h4>
		                    </div>
		                </div>
		            </div>
		        </div>
	...
	<!-- 주로 쓰는 정보 모음 -->
        ...
        <div id="wrapper">
            <div id="loading"></div>
            <div id="calendar">
            <input type="hidden" value="${empNo}" id="myEmpNo"/>
            </div>
        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <input class='inputModal' id="edit-userno" name="edit-userno" type="hidden" value="${empNoCo}">
                            </div>
                        </div>
                        
                        <div class="row">
                            <div class="col-xs-12">
                                <input class='inputModal' id="edit-username2"  name="edit-username2" type="hidden" value="${empNmCo}">
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-xs-12">
                                <input class='calOpenNewEvent' id="edit-calOpen" type="checkbox" hidden>
                            </div>
                        </div>
                        
                        <div class="row">
                            <div class="col-xs-12">
                                <input class='allDayNewEvent' id="edit-allDay" type="checkbox" hidden>
                            </div>
                        </div>
...
<!-- authorize 부분 끝. 중요! -->	
    ...
    <script src="/resources/FullCalendar/WebContent/js/main3.js"></script>
    <script src="/resources/FullCalendar/WebContent/js/addEvent2.js"></script>
