	...
	<div class="row mb-5">
		...
		<div class="col-lg-9 mt-lg-0 mt-4 mb-4">
			...
			<div class="my-0 py-0 mx-0">
				<h2 class="" style="font-color: black;">기안한 문서</h2>
			</div>
			...
			<div class="card">
				...
				<c:out value="selected"/></c:if>>
						...
						<input type="submit" class="btn btn-outline-dark pb-2 m-0 align-middle" style="height:37px;"
							 value="검색">
					</form>
				</div>
			...
			<div class="my-0 py-2 mx-0">
				<h2 class="" style="font-color: black;">결재진행상황</h2>
			</div>
			<div class="card">
				<div class="table-responsive">
