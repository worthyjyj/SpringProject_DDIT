		...
		<div class="card">
			<div class="card-header pb-0">
				<div class="">
									<div class="row mx-0">
					<div class="col-5">
					<h2 class="" style="font-color: black;">결재완료문서함</h2>
					...
					<table class="table align-items-center mb-0">
						<thead>
							<tr>
								...
								<th style="font-size:1.3em;"
									class="text-center text-md font-weight-bolder ">최종결재일시</th>
							</tr>
						</thead>
						<tbody>
								...
								<c:otherwise>
									<c:forEach var="edoc" items="${dataList}" >
										<tr class="getAtrz">
											...
											<td class="align-middle text-center" style="font-size:1.2em;">${edoc.ATRZ_DT}</td>
