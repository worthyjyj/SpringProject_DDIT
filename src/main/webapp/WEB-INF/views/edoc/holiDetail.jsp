				...
				success:function(list){
					...
					if(list.length > 0){
						$.each(list,function(i,v){
	 						code+= "<tr><td class='align-middle text-center'>"+v.ATRZ_RFRNC_NO+"</td>";
...
ul {
	...
	<div class="card m-2 mb-0">
		...
		<table class="px-5 mx-5 mx-auto"
			style="border: 0px solid rgb(0, 0, 0); border-image: none; width: 90%; font-family: malgun gothic, dotum, arial, tahoma; margin-top: 1px; border-collapse: collapse;">
			<!-- Header -->
			<colgroup>
				<col width="310">
				<col width="490">
		...
		<table class="px-5 mx-5 mx-auto"
			style="background: white; border: 1px solid black; border-image: none; width: 90%; color: black; font-family: malgun gothic, dotum, arial, tahoma; font-size: 16px; margin-top: 0px; border-collapse: collapse !important;">
						<colgroup>
				<col width="110">
				<col width="490">
			</colgroup>
			...
			<tbody>
				<tr>
					...
					<c:if test="${list.edocVO.holiVO.holiClsf eq 'HOLI0001'}">연차</c:if>
					<c:if test="${list.edocVO.holiVO.holiClsf eq 'HOLI0002'}">경조사</c:if>
					<c:if test="${list.edocVO.holiVO.holiClsf eq 'HOLI0003'}">포상</c:if>
					</td>
				</tr>
				<tr>
					<td
						...
						기간&nbsp;및&nbsp;일시</td>
					<td
						style="background: rgb(255, 255, 255); padding: 3px; border: 1px solid black; border-image: none; width: 700px; height: 22px; text-align: left; color: rgb(0, 0, 0); font-size: 16px; vertical-align: middle;">
						&nbsp<fmt:formatDate pattern='yyyy-MM-dd' value="${list.edocVO.holiVO.holiBgngYmd}" /> &nbsp;~&nbsp;
						<fmt:formatDate pattern='yyyy-MM-dd' value="${list.edocVO.holiVO.holiEndYmd}" />
					</td>
				</tr>
				...
				<tr>
					...
					<td
						style="background: rgb(255, 255, 255); padding: 3px; border: 1px solid black; border-image: none; width: 700px; height: 22px; text-align: left; color: rgb(0, 0, 0); font-size: 16px; vertical-align: middle;">
						&nbsp${list.edocVO.holiVO.holiAplyCnt}일
					</td>
				</tr>

				<tr>
					<td
						style="background: rgb(221, 221, 221); padding: 5px; border: 1px solid black; border-image: none; height: 80px; text-align: center; color: rgb(0, 0, 0); font-size: 16px; font-weight: bold; vertical-align: middle;"><b
						style="color: rgb(255, 0, 0);">*</b>&nbsp;휴가&nbsp;사유</td>
					<td
						style="background: rgb(255, 255, 255); padding: 3px; border: 1px solid black; border-image: none; width: 700px; height: 300px; text-align: left; color: rgb(0, 0, 0); font-size: 16px; vertical-align: top;">
						${list.edocVO.holiVO.holiCn}
					</td>
				</tr>
...
<div class="row">
  <div class="col-md-4">
    <div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
      <div class="modal-lg modal-dialog modal- modal-dialog-centered modal-" role="document">
        <div class="modal-content">
          <div class="modal-header">
	...
	<table class="w-100">
		<tbody>
				...
				<td>
					<div class="w-100">
						<textarea  id="opinion" name="description" placeholder="반려의견을 입력해주세요" rows="4"
							style="height:100px; margin-left:0px; padding-left : 0px;" class="w-90 my-3"></textarea>
					</div>
				</td>
			</tr>
		</tbody>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-lg bg-gradient-info" id="reject" style="font-size:1.3em;">반려</button>
          </div>
        </div>
      </div>
    </div>
		...
		<tbody>
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-lg bg-gradient-info" data-bs-dismiss="modal" id=""
            		style="font-size:1.3em;">확인</button>
          </div>
        </div>
      </div>
    </div>
