	...
	<div class="row mb-5">
		...
		<div class="col-lg-9 mt-lg-0 mt-4 mb-4">
			...
			<div class="my-0 py-0 mx-0">
				<h2 class="" style="font-color: black;">결재진행문서</h2>
			</div>
			<p class="text-mb mb-2">
					...
					자신이 결재선에 포함된 결재가 진행중인 문서를 조회 할 수 있습니다.
				</p>
			...
			<div class="card">
				...
				<c:out value="selected"/></c:if>>
						...
						<input type="submit" class="btn btn-outline-dark pb-2 m-0 align-middle text-center" style="height:37px;"
							value="검색">
					</form>
				</div>
									...
									<c:forEach var="edoc" items="${dataList}" >
										<tr class="getAtrz">
											...
											<td class="align-middle text-center " style="font-size:1.2em;">
												<a href="" onclick="window.open('/edoc/edocDetail?edocVO.edocNo=${edoc.EDOC_NO}&edocVO.edocFormClsf=${edoc.EDOC_FORM_CLSF}&approve=3','_blank','toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=800, height=1100')">
												${edoc.EDOC_TTL}</a></td>
			...
			<div class="card">
				<div class="table-responsive">
					<table class='table align-items-center mb-0' id='myTable'>
						<thead><tr>
						<th class='text-center text-dark text-md font-weight-bolder' style="font-size:1.2em;">순번</th>
						<th class='text-center text-dark text-md font-weight-bolder' style="font-size:1.2em;">성명</th>
						<th class='text-center text-dark text-md font-weight-bolder' style="font-size:1.2em;">직위</th>
						<th class='text-center text-dark text-md font-weight-bolder' style="font-size:1.2em;">부서</th>
						<th class='text-center text-dark text-md font-weight-bolder' style="font-size:1.2em;">결재상태</th>
						<th class='text-center text-dark text-md font-weight-bolder' style="font-size:1.2em;">결재일시</th>
						</tr></thead>
						<tbody id="getAT">
									<tr>
...
function openApproveDetail(){
 	let No = "${pagingVO.dataMapList[1].EDOC_NO}";
 	let Form = "${pagingVO.dataMapList[0].EDOC_FORM_CLSF}";
 	let Form2 = "${pagingVO.dataMapList}";

	window.open("/edoc/edocDetail?edocVO.edocNo="+No+"&edocVO.edocFormClsf="+Form+"", "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=1000, height=1500");
}
</script>
