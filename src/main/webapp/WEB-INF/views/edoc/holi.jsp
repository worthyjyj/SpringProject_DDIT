			...
			<tbody>
				<tr>
					<td
						...
						휴가&nbsp;종류</td>
					<td
						style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; border-image: none; height: 25px; text-align: left; color: rgb(0, 0, 0); font-size: 16px; font-weight: normal; vertical-align: middle;">
						<span
						style="line-height: normal; font-family: malgun gothic, dotum, arial, tahoma; font-size: 16px; margin-top: 0px; margin-bottom: 0px;">
				...
				<tr>
					...
					<td
						...
						<input class="holiDay" type="date" name="edocVO.holiVO.holiBgngYmd" id="startDate">
						&nbsp;~&nbsp;
				...
				<tr>
					...
					<td
						style="background: rgb(255, 255, 255); padding: 3px; border: 1px solid black; border-image: none; width: 700px; height: 100px; text-align: left; color: rgb(0, 0, 0); font-size: 16px; vertical-align: top;">
				...
				<tr>
					<td
						style="background: rgb(221, 221, 221); padding: 20px !important; border: 1px solid black; border-image: none; width: 100%; height: 22px; text-align: left; vertical-align: middle;"
							...
							<div class="row" id="atrzz">
								<div class="col-lg-4 col-4">
									<div
										...
										<h5 class="text-dark text-gradient mb-0">&nbsp조직도</h5>
											...
											<ul id="browser" class="filetree treeview-famfamfam">
												...
												<i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span
													...
													<ul>
														...
														<li class="dropdownLi"><i class="ni ni-zoom-split-in" style="color: #088ff7;"></i>&nbsp;<span
