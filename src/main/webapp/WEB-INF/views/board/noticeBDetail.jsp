...
<!-- 											<button type="button" class="btn btn-dark btn-sm" id="modi" -->
<%-- 												data-whol-bbs-no="${data.wholBbsNo}">수정</button> --%>
<!-- 											<button type="button" class="btn btn-outline-danger btn-sm" -->
<%-- 												id="del" data-whol-bbs-no="${data.wholBbsNo}">삭제</button> --%>
...
<!-- 									<a href="" class="btn  btn-dark btn">수정</a> -->
<!-- 									<a href="" class="btn btn-outline-danger btn">삭제</a> -->
									<a href="/board/noticeBList" class="btn btn-secondary btn" style="font-size: 1.2em; height: 45px;">목록</a>
								</div>
								...
								<div class="card-body p-3 row" style="margin-left: 15px;">
									...
									<div style="width: 95%; margin-bottom: 10px; border: 2px double gray; padding: 20px;">
										<span style="color: black; font-size: 1.1em;">${data.wholBbsCn}</span>
									</div>
