	...
	<div class="col-12">
		<div class="card mb-4">
			<div class="card-header pb-0 p-3">
				<div class="dropdown">
					<h2><img src="/resources/image/bm.png" style="width: 20px; margin-bottom: 8px;">&nbsp즐겨찾는 자료실</h2>
				</div>
			...
			<div class="card-body p-3" style="margin-bottom: 40px;">
							...
							<div class="card card-blog card-plain">
								<div class="card-body px-1 pb-0">
									...
									<div style="margin-bottom: 5px;  text-align:center;">
										...
										<a href="/upload/download?fileName=${list.ARC_STRG_NM}"><img src="/resources/image/download.png" style="width:30px;"/></a>
				...
				<br />
				<hr class="mt-3" style="border: 3px ridge gray; margin: 20px;">
