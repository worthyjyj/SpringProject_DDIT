	...
	<div class="col-12">
		<div class="card mb-4">
			<div class="card-header pb-0 p-3">
				<div class="dropdown">
					<h2><img src="/resources/image/bm.png" style="width: 20px; margin-bottom: 8px;">&nbsp 부서자료실 >> ${dataList[0].DEPT_NM}</h2>
				</div>
			...
			<div class="card-body" style="margin-bottom: 40px;">
				...
				<c:out value="selected"/></c:if>>
						...
						<input type="submit" class="btn btn-outline-dark btn-xxs m-0 align-middle text-center" style="height:35px;"
							value="검색">
					</form>
						<c:choose>
						...
						<div class=" mb-xl-0 mb-4 col-3" style="border-radius: 10px; margin: 25px; border: 2px double #c8c8c8; width:20%;">
								...
								<div class="card-body px-1 pb-0">
									<div class="row" >
										...
										<div class="col-md-5" align="right" style="margin-top: -15px;">
											...
											<button type="button" style="border: none; background: none; padding: 3px;"><img onclick="clip(this); return false;" alt="Image placeholder" src="/resources/image/share.png" title="PROJ016" style="width: 24px;"></button>
