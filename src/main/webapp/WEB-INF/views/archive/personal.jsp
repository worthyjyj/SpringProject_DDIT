	...
	<div class="col-12">
		<div class="card mb-4">
			<div class="card-header pb-0 p-3">
				<div class="dropdown">
					<h2><img src="/resources/image/bm.png" style="width: 20px; margin-bottom: 8px;">&nbsp개인자료실</h2>
				</div>
			...
			<div class="card-body p-3" style="margin-bottom: 40px;">
				...
				<c:out value="selected"/></c:if>>
						...
						<div class=" mb-xl-0 mb-4" style="border-radius: 10px; margin: 20px; border: 2px double #c8c8c8; width:20%;">
								...
								<div class="card-body px-1 pb-0">
									<div class="row">
										...
										<div class="col-md-5" align="right" style="margin-top: -15px;">
											...
											<img onclick="bMarkList(this)" alt="Image placeholder" src="/resources/image/<c:if test="${list.BOOKMARK == 1}">starli</c:if><c:if test="${list.BOOKMARK == 0}">starbl</c:if>.png" title="${list.ARC_NO}" style="width: 20px;">										</div>
									</div>
